...
fun DynamicTheme(
    ...
    @Suppress("UNUSED_PARAMETER") updateThemeUseCase: UpdateThemeUseCase,
    content: @Composable () -> Unit
) {
    val themeFlow = getThemeUseCase()
    val themePreference by themeFlow.collectAsState(initial = "system")
    ...
    val isDark = when (themePreference) {
        ...
        "light" -> false
            ...
            val systemDark = (config.uiMode and android.content.res.Configuration.UI_MODE_NIGHT_MASK) == android.content.res.Configuration.UI_MODE_NIGHT_YES
            systemDark
        }
    }
